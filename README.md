...
_[Notice: `onepass` is currently undergoing a major revision that is expected to include changes to the passwords generated. Passwords generated by `onepass` v2.x will always remain accessible with v2 binaries.]_
